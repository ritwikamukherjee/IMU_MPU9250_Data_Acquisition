...
{  
 ...
 // With the MPU9250, it is possible to get gyro sample rates of 32 kHz (!), 8 kHz, or 1 kHz CHANGED TO 8KHZ
  I2CwriteByte(MPU9250_ADDRESS, CONFIG, 0x00);  

 // Set sample rate = gyroscope output rate/(1 + SMPLRT_DIV)
  I2CwriteByte(MPU9250_ADDRESS, SMPLRT_DIV, 0x07);  // Use a 1KHz rate; a rate consistent with the filter update rate 
